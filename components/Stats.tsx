  ...
  return (
    <section className="py-16" style={{ background: theme === "dark" ? "#222222" : "#F9F7FC" }}>
      <div className="max-w-5xl mx-auto px-6">
        <div
          className="reveal flex justify-center mb-6"
        >
        ...
        <h2
          className="reveal text-3xl md:text-4xl font-bold text-center mb-3 text-gray-900 dark:text-white max-w-3xl mx-auto"
        >
          Vous faites du bon travail, vos clients sont satisfaits, mais...
        </h2>
        <p
          className="reveal-fade reveal-delay-1 text-gray-500 dark:text-gray-400 text-center mb-14 text-lg"
        >
          ...ils ne pensent pas toujours à vous laisser un avis ?
        </p>

        <div
          className="reveal reveal-delay-1 bg-white dark:bg-[#2a2a2a] rounded-3xl shadow-xl border border-gray-100 dark:border-[#3a3a3a] p-8 md:p-12"
        >
          ...
          <div
            className="stagger-container reveal-fade grid sm:grid-cols-2 gap-8 md:gap-10"
          >
            {stats.map((s) => (
              <div key={s.value} className="stagger-item">
        ...
        <div
          className="reveal reveal-delay-2 text-center mt-10"
        >
